...
export const WORDS = [
    ...
    new Word(
        ...
        'chat',
        'Goodbye',
        require('../assets/images/speechboard/chat/goodbye.png')
    ),
    new Word(
        't3',
        'chat',
    ...
    new Word(
        ...
        'chat',
        'How Are You?',
        require('../assets/images/speechboard/chat/how_are_you.png')
    ),
    new Word(
        't9',
        'chat',
    ...
    new Word(
        ...
        'i feel',
        'Embarrassed',
        require('../assets/images/speechboard/feelings/embarrassed.png')
    ),
    new Word(
        'f15',
        'i feel',
        'Hot',
        require('../assets/images/speechboard/feelings/hot.png')
    ),
    new Word(
        'f16',
        'i feel',
        'Cold',
        require('../assets/images/speechboard/feelings/cold.png')
    ),
    new Word(
        'am1',
        'about me',
    ...
    new Word(
        ...
        'food & drink',
        'Milk',
        require('../assets/images/speechboard/foodanddrink/milk-min.png')
    ),
    new Word(
        'fd11',
        'food & drink',
        'Apple',
        require('../assets/images/speechboard/foodanddrink/apple-min.png')
    ),
    new Word(
        'fd12',
        'food & drink',
    ...
    new Word(
        ...
        'colors',
        'Red',
        require('../assets/images/speechboard/colors/red.png')
    ),
    new Word(
        'c4',
        'colors',
        'Orange',
        require('../assets/images/speechboard/colors/orange.png')
    ),
    new Word(
        'c5',
        'colors',
    ...
    new Word(
        ...
        'colors',
        'Green',
        require('../assets/images/speechboard/colors/green.png')
    ),
    new Word(
        'c8',
        'colors',
    ...
    new Word(
        ...
        'core words',
        'I',
        require('../assets/images/speechboard/corewords/I.png')
    ),
    new Word(
        'cw2',
        'core words',
        'Me',
        // require('../assets/images/speechboard/corewords/me.png')
    ),
    new Word(
        'cw3',
        'core words',
        'You',
        require('../assets/images/speechboard/corewords/you.png')
    ),
    new Word(
        'cw4',
        'core words',
        'he',
        require('../assets/images/speechboard/corewords/he.png')
    ),
    new Word(
        'cw5',
        'core words',
        'She',
        require('../assets/images/speechboard/corewords/she.png')
    ),
    new Word(
        'cw6',
        'core words',
        'We',
        require('../assets/images/speechboard/corewords/we.png')
    ),
    new Word(
        'cw7',
        'core words',
        'They',
        require('../assets/images/speechboard/corewords/they.png')
    ),
    new Word(
        'cw8',
        'core words',
